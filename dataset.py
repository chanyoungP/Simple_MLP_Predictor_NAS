...
class Nb101Dataset(Dataset):
    ...
    def __init__(self, split=None, debug=False):
        self.hash2id = dict()
        with h5py.File("/Users/bagchan-yeong/Desktop/stat_project/data/nasbench.hdf5", mode="r") as f:
        ...
        if split is not None and split != "all":
            self.sample_range = np.load("/Users/bagchan-yeong/Desktop/stat_project/data/train.npz")[str(split)]
        else:
